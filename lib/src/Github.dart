...
class GithubSignInButton extends StatelessWidget {
  ...
  GithubSignInButton(
      ...
      this.splashColor,
      this.darkMode = false,
      // Github doesn't specify a border radius, but this looks about right.
  ...
  Widget build(BuildContext context) {
    return StretchableButton(
      buttonColor: darkMode ? Color(0xFF24292e) : Colors.white,
	  image :darkMode ? 'GitHub-Mark-Light.png' : 'GitHub-Mark.png'
      ...
      centered: centered,
      children: <Widget>[
        // The Github design guidelines aren't consistent. The dark mode
